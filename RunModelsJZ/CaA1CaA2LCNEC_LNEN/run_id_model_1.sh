#!/bin/bash
#SBATCH --job-name=RoformerCaA1CaA2LCNEC
...
#SBATCH --error=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2LCNEC_norm/RoformerA1A2-%j.error
#SBATCH --out=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2LCNEC_norm/RoformerA1A2-%j.out
...
python /gpfs7kw/linkhome/rech/genkmw01/ueu39kt/DDS-RoFormerMIL/scripts/train.py \
                                        --config-name training_LNEN_LCNEC_carcinoids_CaA1CaA2LCNEC_JZ \
