#!/bin/bash
#SBATCH --job-name=RoformerCaA1CaA2LCNEC_bigger
...
#SBATCH --error=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2LCNEC_norm/RoformerCaA1CaA2LCNEC_bigger-%j.error
#SBATCH --out=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2LCNEC_norm/RoformerCaA1CaA2LCNEC_bigger-%j.out
