#!/bin/bash
#SBATCH --job-name=RoformerCaA1CaA2LCNEC_biggest_lower_reg
...
#SBATCH --error=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2LCNEC_norm/RoformerCaA1CaA2LCNEC_biggest_lower_reg-%j.error
#SBATCH --out=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2LCNEC_norm/RoformerCaA1CaA2LCNEC_biggest_lower_reg-%j.out
...
python /linkhome/rech/genkmw01/ueu39kt/DDS-RoFormerMIL/scripts/train.py  --config-name training_LNEN_LCNEC_carcinoids_CaA1CaA2LCNEC_JZ \
                    ...
                    model_dict.BTRoPEAMIL_s_pixel.positional_encoder.dropout=0.2 \
                    model_dict.BTRoPEAMIL_s_pixel.positional_encoder.resid_dropout=0.2 \
                    model_dict.BTRoPEAMIL_s_pixel.mil_head.dropout=0.2
