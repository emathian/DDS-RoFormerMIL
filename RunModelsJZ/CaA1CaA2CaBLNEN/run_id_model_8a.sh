#!/bin/bash
#SBATCH --job-name=RoformerCaA1CaA2CaB_biggest_A
...
#SBATCH --error=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2CaB_norm/RoformerCaA1CaA2CaB_bigges_At-%j.error
#SBATCH --out=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2CaB_norm/RoformerCaA1CaA2CaB_biggest_A-%j.out
...
python /linkhome/rech/genkmw01/ueu39kt/DDS-RoFormerMIL/scripts/train.py  --config-name training_LNEN_LCNEC_carcinoids_CaA1CaA2CaB_JZ \
                    ...
                    model_dict.BTRoPEAMIL_s_pixel.positional_encoder.n_attention_block=12 \
                    model_dict.BTRoPEAMIL_s_pixel.mil_head.attention_net.attention_dim=64 \
                    training_args.callbacks.early_stopping.patience=20 \
                    k_folds.k_start=9 \
                    k_folds.k_end=15
