#!/bin/bash
#SBATCH --job-name=RoformerCaA1CaA2CaB_highreg
...
#SBATCH --error=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2CaB_norm/RoformerCaA1CaA2CaB_highreg-%j.error
#SBATCH --out=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2CaB_norm/RoformerCaA1CaA2CaB_highreg-%j.out
