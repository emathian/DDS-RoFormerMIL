...
#SBATCH --error=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2_norm/RoformerA1A2_smallest_hig_reg_gd1000-%j.error
#SBATCH --out=/gpfsscratch/rech/ryr/ueu39kt/data_RoFormerMIL_LNEN_LCNEC_training_CaA1CaA2_norm/RoformerA1A2_smallest_hig_reg_gd1000-%j.out
...
python /linkhome/rech/genkmw01/ueu39kt/DDS-RoFormerMIL/scripts/train.py  --config-name training_LNEN_LCNEC_CaA1_CaA2_JZ \
                    ...
                    training_args.trainer.gradient_clip_val=1000