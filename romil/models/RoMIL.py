...
class RoPEAMIL(nn.Module):
    ...
    def forward(
        self, features: List[torch.Tensor], coords: List[torch.Tensor], test_process: bool = False,
...
class RoPEDSMIL(nn.Module):
    ...
    def forward(
        self, features: List[torch.Tensor], coords: List[torch.Tensor],   test: bool = False,
